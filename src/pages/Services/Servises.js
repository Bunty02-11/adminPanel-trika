...
export default () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/api/post/work', pageData, {});
  ...
  useEffect(() => {
    axios.get(`http://localhost:8000/api/get/work?page=${currentPage}&perPage=${itemsPerPage}`)
      .then(response => {
